...
function Frame:GetDefaults()
    return {} -- Return an empty table so LoadSettings(the function right below) doesn't crash
	...
	This is not ideal, but it should work for now until I can figure out a better solution.]]--
